...
wire [7:0] init_pads_in_payload_data_i;
...
reg  [7:0] cmdw_pads_out_payload_data_o = 8'd0;
...
wire [7:0] cmdr_pads_in_pads_in_payload_data_i;
reg  [7:0] cmdr_pads_in_pads_in_payload_data_o = 8'd0;
...
reg  [7:0] cmdr_pads_out_payload_data_o = 8'd0;
...
wire [7:0] cmdr_cmdr_pads_in_payload_data_i;
wire [7:0] cmdr_cmdr_pads_in_payload_data_o;
wire cmdr_cmdr_pads_in_payload_data_oe;
wire cmdr_cmdr_pads_in_payload_data_i_ce;
wire cmdr_cmdr_source_source_valid;
reg  cmdr_cmdr_source_source_ready = 1'd0;
wire cmdr_cmdr_source_source_first;
wire cmdr_cmdr_source_source_last;
wire [7:0] cmdr_cmdr_source_source_payload_data;
wire [1:0] cmdr_cmdr_bus_width;
reg  cmdr_cmdr_start = 1'd0;
reg  cmdr_cmdr_run = 1'd0;
wire cmdr_cmdr_conv1_converter_sink_valid;
wire cmdr_cmdr_conv1_converter_sink_ready;
reg  cmdr_cmdr_conv1_converter_sink_first = 1'd0;
reg  cmdr_cmdr_conv1_converter_sink_last = 1'd0;
wire cmdr_cmdr_conv1_converter_sink_payload_data;
wire cmdr_cmdr_conv1_converter_source_valid;
wire cmdr_cmdr_conv1_converter_source_ready;
reg  cmdr_cmdr_conv1_converter_source_first = 1'd0;
reg  cmdr_cmdr_conv1_converter_source_last = 1'd0;
reg  [7:0] cmdr_cmdr_conv1_converter_source_payload_data = 8'd0;
reg  [3:0] cmdr_cmdr_conv1_converter_source_payload_valid_token_count = 4'd0;
reg  [2:0] cmdr_cmdr_conv1_converter_demux = 3'd0;
wire cmdr_cmdr_conv1_converter_load_part;
reg  cmdr_cmdr_conv1_converter_strobe_all = 1'd0;
wire cmdr_cmdr_conv1_source_source_valid;
reg  cmdr_cmdr_conv1_source_source_ready = 1'd0;
wire cmdr_cmdr_conv1_source_source_first;
wire cmdr_cmdr_conv1_source_source_last;
wire [7:0] cmdr_cmdr_conv1_source_source_payload_data;
wire cmdr_cmdr_conv4_converter_sink_valid;
wire cmdr_cmdr_conv4_converter_sink_ready;
reg  cmdr_cmdr_conv4_converter_sink_first = 1'd0;
reg  cmdr_cmdr_conv4_converter_sink_last = 1'd0;
wire [3:0] cmdr_cmdr_conv4_converter_sink_payload_data;
wire cmdr_cmdr_conv4_converter_source_valid;
wire cmdr_cmdr_conv4_converter_source_ready;
reg  cmdr_cmdr_conv4_converter_source_first = 1'd0;
reg  cmdr_cmdr_conv4_converter_source_last = 1'd0;
reg  [7:0] cmdr_cmdr_conv4_converter_source_payload_data = 8'd0;
reg  [1:0] cmdr_cmdr_conv4_converter_source_payload_valid_token_count = 2'd0;
reg  cmdr_cmdr_conv4_converter_demux = 1'd0;
wire cmdr_cmdr_conv4_converter_load_part;
reg  cmdr_cmdr_conv4_converter_strobe_all = 1'd0;
wire cmdr_cmdr_conv4_source_source_valid;
reg  cmdr_cmdr_conv4_source_source_ready = 1'd0;
wire cmdr_cmdr_conv4_source_source_first;
wire cmdr_cmdr_conv4_source_source_last;
wire [7:0] cmdr_cmdr_conv4_source_source_payload_data;
wire cmdr_cmdr_conv8_converter_sink_valid;
wire cmdr_cmdr_conv8_converter_sink_ready;
reg  cmdr_cmdr_conv8_converter_sink_first = 1'd0;
reg  cmdr_cmdr_conv8_converter_sink_last = 1'd0;
wire [7:0] cmdr_cmdr_conv8_converter_sink_payload_data;
wire cmdr_cmdr_conv8_converter_source_valid;
wire cmdr_cmdr_conv8_converter_source_ready;
wire cmdr_cmdr_conv8_converter_source_first;
wire cmdr_cmdr_conv8_converter_source_last;
wire [7:0] cmdr_cmdr_conv8_converter_source_payload_data;
wire cmdr_cmdr_conv8_converter_source_payload_valid_token_count;
wire cmdr_cmdr_conv8_source_source_valid;
reg  cmdr_cmdr_conv8_source_source_ready = 1'd0;
wire cmdr_cmdr_conv8_source_source_first;
wire cmdr_cmdr_conv8_source_source_last;
wire [7:0] cmdr_cmdr_conv8_source_source_payload_data;
reg  cmdr_cmdr_buf_sink_valid = 1'd0;
wire cmdr_cmdr_buf_sink_ready;
reg  cmdr_cmdr_buf_sink_first = 1'd0;
reg  cmdr_cmdr_buf_sink_last = 1'd0;
reg  [7:0] cmdr_cmdr_buf_sink_payload_data = 8'd0;
...
wire [7:0] dataw_pads_in_pads_in_payload_data_i;
reg  [7:0] dataw_pads_in_pads_in_payload_data_o = 8'd0;
...
reg  [7:0] dataw_pads_out_payload_data_o = 8'd0;
...
wire [7:0] dataw_crc_pads_in_payload_data_i;
wire [7:0] dataw_crc_pads_in_payload_data_o;
wire dataw_crc_pads_in_payload_data_oe;
wire dataw_crc_pads_in_payload_data_i_ce;
wire dataw_crc_source_source_valid;
reg  dataw_crc_source_source_ready = 1'd0;
wire dataw_crc_source_source_first;
wire dataw_crc_source_source_last;
wire [7:0] dataw_crc_source_source_payload_data;
wire [1:0] dataw_crc_bus_width;
reg  dataw_crc_start = 1'd0;
reg  dataw_crc_run = 1'd0;
wire dataw_crc_conv1_converter_sink_valid;
wire dataw_crc_conv1_converter_sink_ready;
reg  dataw_crc_conv1_converter_sink_first = 1'd0;
reg  dataw_crc_conv1_converter_sink_last = 1'd0;
wire dataw_crc_conv1_converter_sink_payload_data;
wire dataw_crc_conv1_converter_source_valid;
wire dataw_crc_conv1_converter_source_ready;
reg  dataw_crc_conv1_converter_source_first = 1'd0;
reg  dataw_crc_conv1_converter_source_last = 1'd0;
reg  [7:0] dataw_crc_conv1_converter_source_payload_data = 8'd0;
reg  [3:0] dataw_crc_conv1_converter_source_payload_valid_token_count = 4'd0;
reg  [2:0] dataw_crc_conv1_converter_demux = 3'd0;
wire dataw_crc_conv1_converter_load_part;
reg  dataw_crc_conv1_converter_strobe_all = 1'd0;
wire dataw_crc_conv1_source_source_valid;
reg  dataw_crc_conv1_source_source_ready = 1'd0;
wire dataw_crc_conv1_source_source_first;
wire dataw_crc_conv1_source_source_last;
wire [7:0] dataw_crc_conv1_source_source_payload_data;
wire dataw_crc_conv4_converter_sink_valid;
wire dataw_crc_conv4_converter_sink_ready;
reg  dataw_crc_conv4_converter_sink_first = 1'd0;
reg  dataw_crc_conv4_converter_sink_last = 1'd0;
wire [3:0] dataw_crc_conv4_converter_sink_payload_data;
wire dataw_crc_conv4_converter_source_valid;
wire dataw_crc_conv4_converter_source_ready;
reg  dataw_crc_conv4_converter_source_first = 1'd0;
reg  dataw_crc_conv4_converter_source_last = 1'd0;
reg  [7:0] dataw_crc_conv4_converter_source_payload_data = 8'd0;
reg  [1:0] dataw_crc_conv4_converter_source_payload_valid_token_count = 2'd0;
reg  dataw_crc_conv4_converter_demux = 1'd0;
wire dataw_crc_conv4_converter_load_part;
reg  dataw_crc_conv4_converter_strobe_all = 1'd0;
wire dataw_crc_conv4_source_source_valid;
reg  dataw_crc_conv4_source_source_ready = 1'd0;
wire dataw_crc_conv4_source_source_first;
wire dataw_crc_conv4_source_source_last;
wire [7:0] dataw_crc_conv4_source_source_payload_data;
wire dataw_crc_conv8_converter_sink_valid;
wire dataw_crc_conv8_converter_sink_ready;
reg  dataw_crc_conv8_converter_sink_first = 1'd0;
reg  dataw_crc_conv8_converter_sink_last = 1'd0;
wire [7:0] dataw_crc_conv8_converter_sink_payload_data;
wire dataw_crc_conv8_converter_source_valid;
wire dataw_crc_conv8_converter_source_ready;
wire dataw_crc_conv8_converter_source_first;
wire dataw_crc_conv8_converter_source_last;
wire [7:0] dataw_crc_conv8_converter_source_payload_data;
wire dataw_crc_conv8_converter_source_payload_valid_token_count;
wire dataw_crc_conv8_source_source_valid;
reg  dataw_crc_conv8_source_source_ready = 1'd0;
wire dataw_crc_conv8_source_source_first;
wire dataw_crc_conv8_source_source_last;
wire [7:0] dataw_crc_conv8_source_source_payload_data;
reg  dataw_crc_buf_sink_valid = 1'd0;
wire dataw_crc_buf_sink_ready;
reg  dataw_crc_buf_sink_first = 1'd0;
reg  dataw_crc_buf_sink_last = 1'd0;
reg  [7:0] dataw_crc_buf_sink_payload_data = 8'd0;
...
wire [7:0] datar_pads_in_pads_in_payload_data_i;
reg  [7:0] datar_pads_in_pads_in_payload_data_o = 8'd0;
...
reg  [7:0] datar_pads_out_payload_data_o = 8'd0;
...
wire [7:0] datar_datar_pads_in_payload_data_i;
wire [7:0] datar_datar_pads_in_payload_data_o;
wire datar_datar_pads_in_payload_data_oe;
wire datar_datar_pads_in_payload_data_i_ce;
wire datar_datar_source_source_valid;
reg  datar_datar_source_source_ready = 1'd0;
wire datar_datar_source_source_first;
wire datar_datar_source_source_last;
wire [7:0] datar_datar_source_source_payload_data;
wire [1:0] datar_datar_bus_width;
reg  datar_datar_start = 1'd0;
reg  datar_datar_run = 1'd0;
wire datar_datar_conv1_converter_sink_valid;
wire datar_datar_conv1_converter_sink_ready;
reg  datar_datar_conv1_converter_sink_first = 1'd0;
reg  datar_datar_conv1_converter_sink_last = 1'd0;
wire datar_datar_conv1_converter_sink_payload_data;
wire datar_datar_conv1_converter_source_valid;
wire datar_datar_conv1_converter_source_ready;
reg  datar_datar_conv1_converter_source_first = 1'd0;
reg  datar_datar_conv1_converter_source_last = 1'd0;
reg  [7:0] datar_datar_conv1_converter_source_payload_data = 8'd0;
reg  [3:0] datar_datar_conv1_converter_source_payload_valid_token_count = 4'd0;
reg  [2:0] datar_datar_conv1_converter_demux = 3'd0;
wire datar_datar_conv1_converter_load_part;
reg  datar_datar_conv1_converter_strobe_all = 1'd0;
wire datar_datar_conv1_source_source_valid;
reg  datar_datar_conv1_source_source_ready = 1'd0;
wire datar_datar_conv1_source_source_first;
wire datar_datar_conv1_source_source_last;
wire [7:0] datar_datar_conv1_source_source_payload_data;
wire datar_datar_conv4_converter_sink_valid;
wire datar_datar_conv4_converter_sink_ready;
reg  datar_datar_conv4_converter_sink_first = 1'd0;
reg  datar_datar_conv4_converter_sink_last = 1'd0;
wire [3:0] datar_datar_conv4_converter_sink_payload_data;
wire datar_datar_conv4_converter_source_valid;
wire datar_datar_conv4_converter_source_ready;
reg  datar_datar_conv4_converter_source_first = 1'd0;
reg  datar_datar_conv4_converter_source_last = 1'd0;
reg  [7:0] datar_datar_conv4_converter_source_payload_data = 8'd0;
reg  [1:0] datar_datar_conv4_converter_source_payload_valid_token_count = 2'd0;
reg  datar_datar_conv4_converter_demux = 1'd0;
wire datar_datar_conv4_converter_load_part;
reg  datar_datar_conv4_converter_strobe_all = 1'd0;
wire datar_datar_conv4_source_source_valid;
reg  datar_datar_conv4_source_source_ready = 1'd0;
wire datar_datar_conv4_source_source_first;
wire datar_datar_conv4_source_source_last;
wire [7:0] datar_datar_conv4_source_source_payload_data;
wire datar_datar_conv8_converter_sink_valid;
wire datar_datar_conv8_converter_sink_ready;
reg  datar_datar_conv8_converter_sink_first = 1'd0;
reg  datar_datar_conv8_converter_sink_last = 1'd0;
wire [7:0] datar_datar_conv8_converter_sink_payload_data;
wire datar_datar_conv8_converter_source_valid;
wire datar_datar_conv8_converter_source_ready;
wire datar_datar_conv8_converter_source_first;
wire datar_datar_conv8_converter_source_last;
wire [7:0] datar_datar_conv8_converter_source_payload_data;
wire datar_datar_conv8_converter_source_payload_valid_token_count;
wire datar_datar_conv8_source_source_valid;
reg  datar_datar_conv8_source_source_ready = 1'd0;
wire datar_datar_conv8_source_source_first;
wire datar_datar_conv8_source_source_last;
wire [7:0] datar_datar_conv8_source_source_payload_data;
reg  datar_datar_buf_sink_valid = 1'd0;
wire datar_datar_buf_sink_ready;
reg  datar_datar_buf_sink_first = 1'd0;
reg  datar_datar_buf_sink_last = 1'd0;
reg  [7:0] datar_datar_buf_sink_payload_data = 8'd0;
...
reg  [1:0] bus_width_storage = 2'd2;
reg  bus_width_re = 1'd0;
wire sdpads_clk;
reg  sdpads_cmd_i = 1'd0;
wire sdpads_cmd_o;
wire sdpads_cmd_oe;
reg  [7:0] sdpads_data_i = 8'd0;
wire [7:0] sdpads_data_o;
wire sdpads_data_oe;
...
reg  csrbank5_bus_width0_re = 1'd0;
wire [1:0] csrbank5_bus_width0_r;
reg  csrbank5_bus_width0_we = 1'd0;
wire [1:0] csrbank5_bus_width0_w;
wire csrbank5_sel;
...
reg  [3:0] litesdcardcore_sdphydataw_state = 4'd0;
reg  [3:0] litesdcardcore_sdphydataw_next_state = 4'd0;
...
reg  xilinxsdrtristateimpl5__o = 1'd0;
reg  xilinxsdrtristateimpl5_oe_n = 1'd0;
wire xilinxsdrtristateimpl5__i;
reg  xilinxsdrtristateimpl6__o = 1'd0;
reg  xilinxsdrtristateimpl6_oe_n = 1'd0;
wire xilinxsdrtristateimpl6__i;
reg  xilinxsdrtristateimpl7__o = 1'd0;
reg  xilinxsdrtristateimpl7_oe_n = 1'd0;
wire xilinxsdrtristateimpl7__i;
reg  xilinxsdrtristateimpl8__o = 1'd0;
reg  xilinxsdrtristateimpl8_oe_n = 1'd0;
wire xilinxsdrtristateimpl8__i;
wire sdrio_clk_1;
wire sdrio_clk_2;
wire sdrio_clk_3;
wire sdrio_clk_4;
...
assign dataw_bus_width = bus_width_storage;
assign datar_bus_width = bus_width_storage;
always @(*) begin
	clocker_clk1 <= 1'd0;
...
always @(*) begin
	...
	init_pads_out_payload_data_o <= 8'd0;
...
assign cmdr_cmdr_bus_width = 1'd1;
always @(*) begin
	cmdr_cmdr_start <= 1'd0;
	case (cmdr_cmdr_bus_width)
		1'd1: begin
			cmdr_cmdr_start <= (cmdr_cmdr_pads_in_payload_cmd_i == 1'd0);
		end
		2'd2: begin
			cmdr_cmdr_start <= (cmdr_cmdr_pads_in_payload_cmd_i == 1'd0);
		end
...
assign cmdr_cmdr_conv1_converter_sink_valid = (cmdr_cmdr_pads_in_valid & (cmdr_cmdr_start | cmdr_cmdr_run));
assign cmdr_cmdr_conv4_converter_sink_valid = (cmdr_cmdr_pads_in_valid & (cmdr_cmdr_start | cmdr_cmdr_run));
assign cmdr_cmdr_conv8_converter_sink_valid = (cmdr_cmdr_pads_in_valid & (cmdr_cmdr_start | cmdr_cmdr_run));
assign cmdr_cmdr_conv1_converter_sink_payload_data = cmdr_cmdr_pads_in_payload_cmd_i;
assign cmdr_cmdr_conv4_converter_sink_payload_data = cmdr_cmdr_pads_in_payload_cmd_i;
assign cmdr_cmdr_conv8_converter_sink_payload_data = cmdr_cmdr_pads_in_payload_cmd_i;
always @(*) begin
	cmdr_cmdr_buf_sink_first <= 1'd0;
	cmdr_cmdr_buf_sink_last <= 1'd0;
	cmdr_cmdr_conv4_source_source_ready <= 1'd0;
	cmdr_cmdr_buf_sink_payload_data <= 8'd0;
	cmdr_cmdr_conv8_source_source_ready <= 1'd0;
	cmdr_cmdr_conv1_source_source_ready <= 1'd0;
	cmdr_cmdr_buf_sink_valid <= 1'd0;
	case (cmdr_cmdr_bus_width)
		2'd2: begin
			cmdr_cmdr_buf_sink_valid <= cmdr_cmdr_conv4_source_source_valid;
			cmdr_cmdr_conv4_source_source_ready <= cmdr_cmdr_buf_sink_ready;
			cmdr_cmdr_buf_sink_first <= cmdr_cmdr_conv4_source_source_first;
			cmdr_cmdr_buf_sink_last <= cmdr_cmdr_conv4_source_source_last;
			cmdr_cmdr_buf_sink_payload_data <= cmdr_cmdr_conv4_source_source_payload_data;
		end
		2'd3: begin
			cmdr_cmdr_buf_sink_valid <= cmdr_cmdr_conv8_source_source_valid;
			cmdr_cmdr_conv8_source_source_ready <= cmdr_cmdr_buf_sink_ready;
			cmdr_cmdr_buf_sink_first <= cmdr_cmdr_conv8_source_source_first;
			cmdr_cmdr_buf_sink_last <= cmdr_cmdr_conv8_source_source_last;
			cmdr_cmdr_buf_sink_payload_data <= cmdr_cmdr_conv8_source_source_payload_data;
		end
		default: begin
			cmdr_cmdr_buf_sink_valid <= cmdr_cmdr_conv1_source_source_valid;
			cmdr_cmdr_conv1_source_source_ready <= cmdr_cmdr_buf_sink_ready;
			cmdr_cmdr_buf_sink_first <= cmdr_cmdr_conv1_source_source_first;
			cmdr_cmdr_buf_sink_last <= cmdr_cmdr_conv1_source_source_last;
			cmdr_cmdr_buf_sink_payload_data <= cmdr_cmdr_conv1_source_source_payload_data;
		end
	endcase
end
assign cmdr_cmdr_source_source_valid = cmdr_cmdr_buf_source_valid;
assign cmdr_cmdr_buf_source_ready = cmdr_cmdr_source_source_ready;
assign cmdr_cmdr_source_source_first = cmdr_cmdr_buf_source_first;
assign cmdr_cmdr_source_source_last = cmdr_cmdr_buf_source_last;
assign cmdr_cmdr_source_source_payload_data = cmdr_cmdr_buf_source_payload_data;
assign cmdr_cmdr_conv1_source_source_valid = cmdr_cmdr_conv1_converter_source_valid;
assign cmdr_cmdr_conv1_converter_source_ready = cmdr_cmdr_conv1_source_source_ready;
assign cmdr_cmdr_conv1_source_source_first = cmdr_cmdr_conv1_converter_source_first;
assign cmdr_cmdr_conv1_source_source_last = cmdr_cmdr_conv1_converter_source_last;
assign cmdr_cmdr_conv1_source_source_payload_data = cmdr_cmdr_conv1_converter_source_payload_data;
assign cmdr_cmdr_conv1_converter_sink_ready = ((~cmdr_cmdr_conv1_converter_strobe_all) | cmdr_cmdr_conv1_converter_source_ready);
assign cmdr_cmdr_conv1_converter_source_valid = cmdr_cmdr_conv1_converter_strobe_all;
assign cmdr_cmdr_conv1_converter_load_part = (cmdr_cmdr_conv1_converter_sink_valid & cmdr_cmdr_conv1_converter_sink_ready);
assign cmdr_cmdr_conv4_source_source_valid = cmdr_cmdr_conv4_converter_source_valid;
assign cmdr_cmdr_conv4_converter_source_ready = cmdr_cmdr_conv4_source_source_ready;
assign cmdr_cmdr_conv4_source_source_first = cmdr_cmdr_conv4_converter_source_first;
assign cmdr_cmdr_conv4_source_source_last = cmdr_cmdr_conv4_converter_source_last;
assign cmdr_cmdr_conv4_source_source_payload_data = cmdr_cmdr_conv4_converter_source_payload_data;
assign cmdr_cmdr_conv4_converter_sink_ready = ((~cmdr_cmdr_conv4_converter_strobe_all) | cmdr_cmdr_conv4_converter_source_ready);
assign cmdr_cmdr_conv4_converter_source_valid = cmdr_cmdr_conv4_converter_strobe_all;
assign cmdr_cmdr_conv4_converter_load_part = (cmdr_cmdr_conv4_converter_sink_valid & cmdr_cmdr_conv4_converter_sink_ready);
assign cmdr_cmdr_conv8_source_source_valid = cmdr_cmdr_conv8_converter_source_valid;
assign cmdr_cmdr_conv8_converter_source_ready = cmdr_cmdr_conv8_source_source_ready;
assign cmdr_cmdr_conv8_source_source_first = cmdr_cmdr_conv8_converter_source_first;
assign cmdr_cmdr_conv8_source_source_last = cmdr_cmdr_conv8_converter_source_last;
assign cmdr_cmdr_conv8_source_source_payload_data = cmdr_cmdr_conv8_converter_source_payload_data;
assign cmdr_cmdr_conv8_converter_source_valid = cmdr_cmdr_conv8_converter_sink_valid;
assign cmdr_cmdr_conv8_converter_sink_ready = cmdr_cmdr_conv8_converter_source_ready;
assign cmdr_cmdr_conv8_converter_source_first = cmdr_cmdr_conv8_converter_sink_first;
assign cmdr_cmdr_conv8_converter_source_last = cmdr_cmdr_conv8_converter_sink_last;
assign cmdr_cmdr_conv8_converter_source_payload_data = cmdr_cmdr_conv8_converter_sink_payload_data;
assign cmdr_cmdr_conv8_converter_source_payload_valid_token_count = 1'd1;
...
always @(*) begin
	...
	cmdr_cmdr_source_source_ready <= 1'd0;
	...
	case (litesdcardcore_sdphycmdr_state)
		1'd1: begin
			...
			if (cmdr_cmdr_source_source_valid) begin
		...
		2'd2: begin
			cmdr_pads_out_payload_clk <= 1'd1;
			cmdr_source_valid <= cmdr_cmdr_source_source_valid;
			cmdr_source_payload_status <= 1'd0;
			cmdr_source_last <= (cmdr_count == (cmdr_sink_payload_length - 1'd1));
			cmdr_source_payload_data <= cmdr_cmdr_source_source_payload_data;
			if ((cmdr_cmdr_source_source_valid & cmdr_source_ready)) begin
				cmdr_cmdr_source_source_ready <= 1'd1;
...
assign dataw_crc_bus_width = 1'd1;
always @(*) begin
	dataw_crc_start <= 1'd0;
	case (dataw_crc_bus_width)
		1'd1: begin
			dataw_crc_start <= (dataw_crc_pads_in_payload_data_i[0] == 1'd0);
		end
		2'd2: begin
			dataw_crc_start <= (dataw_crc_pads_in_payload_data_i[3:0] == 1'd0);
		end
		2'd3: begin
			dataw_crc_start <= (dataw_crc_pads_in_payload_data_i[7:0] == 1'd0);
		end
	endcase
end
assign dataw_crc_conv1_converter_sink_valid = (dataw_crc_pads_in_valid & dataw_crc_run);
assign dataw_crc_conv4_converter_sink_valid = (dataw_crc_pads_in_valid & dataw_crc_run);
assign dataw_crc_conv8_converter_sink_valid = (dataw_crc_pads_in_valid & dataw_crc_run);
assign dataw_crc_conv1_converter_sink_payload_data = dataw_crc_pads_in_payload_data_i;
assign dataw_crc_conv4_converter_sink_payload_data = dataw_crc_pads_in_payload_data_i;
assign dataw_crc_conv8_converter_sink_payload_data = dataw_crc_pads_in_payload_data_i;
always @(*) begin
	dataw_crc_buf_sink_valid <= 1'd0;
	dataw_crc_conv8_source_source_ready <= 1'd0;
	dataw_crc_buf_sink_first <= 1'd0;
	dataw_crc_buf_sink_last <= 1'd0;
	dataw_crc_conv4_source_source_ready <= 1'd0;
	dataw_crc_buf_sink_payload_data <= 8'd0;
	dataw_crc_conv1_source_source_ready <= 1'd0;
	case (dataw_crc_bus_width)
		2'd2: begin
			dataw_crc_buf_sink_valid <= dataw_crc_conv4_source_source_valid;
			dataw_crc_conv4_source_source_ready <= dataw_crc_buf_sink_ready;
			dataw_crc_buf_sink_first <= dataw_crc_conv4_source_source_first;
			dataw_crc_buf_sink_last <= dataw_crc_conv4_source_source_last;
			dataw_crc_buf_sink_payload_data <= dataw_crc_conv4_source_source_payload_data;
		end
		2'd3: begin
			dataw_crc_buf_sink_valid <= dataw_crc_conv8_source_source_valid;
			dataw_crc_conv8_source_source_ready <= dataw_crc_buf_sink_ready;
			dataw_crc_buf_sink_first <= dataw_crc_conv8_source_source_first;
			dataw_crc_buf_sink_last <= dataw_crc_conv8_source_source_last;
			dataw_crc_buf_sink_payload_data <= dataw_crc_conv8_source_source_payload_data;
		end
		default: begin
			dataw_crc_buf_sink_valid <= dataw_crc_conv1_source_source_valid;
			dataw_crc_conv1_source_source_ready <= dataw_crc_buf_sink_ready;
			dataw_crc_buf_sink_first <= dataw_crc_conv1_source_source_first;
			dataw_crc_buf_sink_last <= dataw_crc_conv1_source_source_last;
			dataw_crc_buf_sink_payload_data <= dataw_crc_conv1_source_source_payload_data;
		end
	endcase
end
assign dataw_crc_source_source_valid = dataw_crc_buf_source_valid;
assign dataw_crc_buf_source_ready = dataw_crc_source_source_ready;
assign dataw_crc_source_source_first = dataw_crc_buf_source_first;
assign dataw_crc_source_source_last = dataw_crc_buf_source_last;
assign dataw_crc_source_source_payload_data = dataw_crc_buf_source_payload_data;
assign dataw_crc_conv1_source_source_valid = dataw_crc_conv1_converter_source_valid;
assign dataw_crc_conv1_converter_source_ready = dataw_crc_conv1_source_source_ready;
assign dataw_crc_conv1_source_source_first = dataw_crc_conv1_converter_source_first;
assign dataw_crc_conv1_source_source_last = dataw_crc_conv1_converter_source_last;
assign dataw_crc_conv1_source_source_payload_data = dataw_crc_conv1_converter_source_payload_data;
assign dataw_crc_conv1_converter_sink_ready = ((~dataw_crc_conv1_converter_strobe_all) | dataw_crc_conv1_converter_source_ready);
assign dataw_crc_conv1_converter_source_valid = dataw_crc_conv1_converter_strobe_all;
assign dataw_crc_conv1_converter_load_part = (dataw_crc_conv1_converter_sink_valid & dataw_crc_conv1_converter_sink_ready);
assign dataw_crc_conv4_source_source_valid = dataw_crc_conv4_converter_source_valid;
assign dataw_crc_conv4_converter_source_ready = dataw_crc_conv4_source_source_ready;
assign dataw_crc_conv4_source_source_first = dataw_crc_conv4_converter_source_first;
assign dataw_crc_conv4_source_source_last = dataw_crc_conv4_converter_source_last;
assign dataw_crc_conv4_source_source_payload_data = dataw_crc_conv4_converter_source_payload_data;
assign dataw_crc_conv4_converter_sink_ready = ((~dataw_crc_conv4_converter_strobe_all) | dataw_crc_conv4_converter_source_ready);
assign dataw_crc_conv4_converter_source_valid = dataw_crc_conv4_converter_strobe_all;
assign dataw_crc_conv4_converter_load_part = (dataw_crc_conv4_converter_sink_valid & dataw_crc_conv4_converter_sink_ready);
assign dataw_crc_conv8_source_source_valid = dataw_crc_conv8_converter_source_valid;
assign dataw_crc_conv8_converter_source_ready = dataw_crc_conv8_source_source_ready;
assign dataw_crc_conv8_source_source_first = dataw_crc_conv8_converter_source_first;
assign dataw_crc_conv8_source_source_last = dataw_crc_conv8_converter_source_last;
assign dataw_crc_conv8_source_source_payload_data = dataw_crc_conv8_converter_source_payload_data;
assign dataw_crc_conv8_converter_source_valid = dataw_crc_conv8_converter_sink_valid;
assign dataw_crc_conv8_converter_sink_ready = dataw_crc_conv8_converter_source_ready;
assign dataw_crc_conv8_converter_source_first = dataw_crc_conv8_converter_sink_first;
assign dataw_crc_conv8_converter_source_last = dataw_crc_conv8_converter_sink_last;
assign dataw_crc_conv8_converter_source_payload_data = dataw_crc_conv8_converter_sink_payload_data;
assign dataw_crc_conv8_converter_source_payload_valid_token_count = 1'd1;
assign dataw_crc_buf_sink_ready = ((~dataw_crc_buf_source_valid) | dataw_crc_buf_source_ready);
always @(*) begin
	dataw_crc_reset <= 1'd0;
	litesdcardcore_sdphydataw_next_state <= 4'd0;
	...
	dataw_pads_out_payload_data_o <= 8'd0;
	...
	case (litesdcardcore_sdphydataw_state)
		...
		2'd2: begin
			...
			if (dataw_pads_out_ready) begin
				if ((dataw_bus_width == 1'd1)) begin
					litesdcardcore_sdphydataw_next_state <= 2'd3;
				end
				if ((dataw_bus_width == 2'd2)) begin
					litesdcardcore_sdphydataw_next_state <= 3'd4;
				end
				if ((dataw_bus_width == 2'd3)) begin
		...
		2'd3: begin
			...
			case (dataw_count)
				1'd0: begin
					dataw_pads_out_payload_data_o <= dataw_sink_payload_data[7];
				end
				1'd1: begin
					dataw_pads_out_payload_data_o <= dataw_sink_payload_data[6];
				end
				2'd2: begin
					dataw_pads_out_payload_data_o <= dataw_sink_payload_data[5];
				end
				2'd3: begin
					dataw_pads_out_payload_data_o <= dataw_sink_payload_data[4];
				end
				3'd4: begin
					dataw_pads_out_payload_data_o <= dataw_sink_payload_data[3];
				end
				3'd5: begin
					dataw_pads_out_payload_data_o <= dataw_sink_payload_data[2];
				end
				3'd6: begin
					dataw_pads_out_payload_data_o <= dataw_sink_payload_data[1];
				end
				3'd7: begin
					dataw_pads_out_payload_data_o <= dataw_sink_payload_data[0];
				end
			endcase
			if (dataw_pads_out_ready) begin
				dataw_count_sdphydataw_next_value3 <= (dataw_count + 1'd1);
		...
		3'd5: begin
			...
			dataw_pads_out_payload_clk <= 1'd1;
			dataw_pads_out_payload_data_oe <= 1'd1;
			dataw_pads_out_payload_data_o <= dataw_sink_payload_data;
			if (dataw_pads_out_ready) begin
				if (dataw_sink_last) begin
					litesdcardcore_sdphydataw_next_state <= 3'd6;
				end else begin
		...
		3'd6: begin
			...
			if (dataw_pads_out_ready) begin
				...
				litesdcardcore_sdphydataw_next_state <= 3'd7;
			end
		end
		3'd7: begin
			dataw_pads_out_payload_clk <= 1'd1;
			if (dataw_crc_source_source_valid) begin
				dataw_accepted1_sdphydataw_next_value0 <= (dataw_crc_source_source_payload_data[7:5] == 2'd2);
				dataw_accepted1_sdphydataw_next_value_ce0 <= 1'd1;
				dataw_crc_error1_sdphydataw_next_value1 <= (dataw_crc_source_source_payload_data[7:5] == 3'd5);
				dataw_crc_error1_sdphydataw_next_value_ce1 <= 1'd1;
				dataw_write_error1_sdphydataw_next_value2 <= (dataw_crc_source_source_payload_data[7:5] == 3'd6);
				dataw_write_error1_sdphydataw_next_value_ce2 <= 1'd1;
				litesdcardcore_sdphydataw_next_state <= 4'd8;
			end
		end
		4'd8: begin
			dataw_pads_out_payload_clk <= 1'd1;
...
assign datar_datar_bus_width = datar_bus_width;
always @(*) begin
	datar_datar_start <= 1'd0;
	case (datar_datar_bus_width)
		1'd1: begin
			datar_datar_start <= (datar_datar_pads_in_payload_data_i[0] == 1'd0);
		end
		2'd2: begin
			datar_datar_start <= (datar_datar_pads_in_payload_data_i[3:0] == 1'd0);
		end
		2'd3: begin
			datar_datar_start <= (datar_datar_pads_in_payload_data_i[7:0] == 1'd0);
		end
	endcase
end
assign datar_datar_conv1_converter_sink_valid = (datar_datar_pads_in_valid & datar_datar_run);
assign datar_datar_conv4_converter_sink_valid = (datar_datar_pads_in_valid & datar_datar_run);
assign datar_datar_conv8_converter_sink_valid = (datar_datar_pads_in_valid & datar_datar_run);
assign datar_datar_conv1_converter_sink_payload_data = datar_datar_pads_in_payload_data_i;
assign datar_datar_conv4_converter_sink_payload_data = datar_datar_pads_in_payload_data_i;
assign datar_datar_conv8_converter_sink_payload_data = datar_datar_pads_in_payload_data_i;
always @(*) begin
	datar_datar_buf_sink_first <= 1'd0;
	datar_datar_buf_sink_last <= 1'd0;
	datar_datar_conv4_source_source_ready <= 1'd0;
	datar_datar_buf_sink_payload_data <= 8'd0;
	datar_datar_conv8_source_source_ready <= 1'd0;
	datar_datar_conv1_source_source_ready <= 1'd0;
	datar_datar_buf_sink_valid <= 1'd0;
	case (datar_datar_bus_width)
		2'd2: begin
			datar_datar_buf_sink_valid <= datar_datar_conv4_source_source_valid;
			datar_datar_conv4_source_source_ready <= datar_datar_buf_sink_ready;
			datar_datar_buf_sink_first <= datar_datar_conv4_source_source_first;
			datar_datar_buf_sink_last <= datar_datar_conv4_source_source_last;
			datar_datar_buf_sink_payload_data <= datar_datar_conv4_source_source_payload_data;
		end
		2'd3: begin
			datar_datar_buf_sink_valid <= datar_datar_conv8_source_source_valid;
			datar_datar_conv8_source_source_ready <= datar_datar_buf_sink_ready;
			datar_datar_buf_sink_first <= datar_datar_conv8_source_source_first;
			datar_datar_buf_sink_last <= datar_datar_conv8_source_source_last;
			datar_datar_buf_sink_payload_data <= datar_datar_conv8_source_source_payload_data;
		end
		default: begin
			datar_datar_buf_sink_valid <= datar_datar_conv1_source_source_valid;
			datar_datar_conv1_source_source_ready <= datar_datar_buf_sink_ready;
			datar_datar_buf_sink_first <= datar_datar_conv1_source_source_first;
			datar_datar_buf_sink_last <= datar_datar_conv1_source_source_last;
			datar_datar_buf_sink_payload_data <= datar_datar_conv1_source_source_payload_data;
		end
	endcase
end
assign datar_datar_source_source_valid = datar_datar_buf_source_valid;
assign datar_datar_buf_source_ready = datar_datar_source_source_ready;
assign datar_datar_source_source_first = datar_datar_buf_source_first;
assign datar_datar_source_source_last = datar_datar_buf_source_last;
assign datar_datar_source_source_payload_data = datar_datar_buf_source_payload_data;
assign datar_datar_conv1_source_source_valid = datar_datar_conv1_converter_source_valid;
assign datar_datar_conv1_converter_source_ready = datar_datar_conv1_source_source_ready;
assign datar_datar_conv1_source_source_first = datar_datar_conv1_converter_source_first;
assign datar_datar_conv1_source_source_last = datar_datar_conv1_converter_source_last;
assign datar_datar_conv1_source_source_payload_data = datar_datar_conv1_converter_source_payload_data;
assign datar_datar_conv1_converter_sink_ready = ((~datar_datar_conv1_converter_strobe_all) | datar_datar_conv1_converter_source_ready);
assign datar_datar_conv1_converter_source_valid = datar_datar_conv1_converter_strobe_all;
assign datar_datar_conv1_converter_load_part = (datar_datar_conv1_converter_sink_valid & datar_datar_conv1_converter_sink_ready);
assign datar_datar_conv4_source_source_valid = datar_datar_conv4_converter_source_valid;
assign datar_datar_conv4_converter_source_ready = datar_datar_conv4_source_source_ready;
assign datar_datar_conv4_source_source_first = datar_datar_conv4_converter_source_first;
assign datar_datar_conv4_source_source_last = datar_datar_conv4_converter_source_last;
assign datar_datar_conv4_source_source_payload_data = datar_datar_conv4_converter_source_payload_data;
assign datar_datar_conv4_converter_sink_ready = ((~datar_datar_conv4_converter_strobe_all) | datar_datar_conv4_converter_source_ready);
assign datar_datar_conv4_converter_source_valid = datar_datar_conv4_converter_strobe_all;
assign datar_datar_conv4_converter_load_part = (datar_datar_conv4_converter_sink_valid & datar_datar_conv4_converter_sink_ready);
assign datar_datar_conv8_source_source_valid = datar_datar_conv8_converter_source_valid;
assign datar_datar_conv8_converter_source_ready = datar_datar_conv8_source_source_ready;
assign datar_datar_conv8_source_source_first = datar_datar_conv8_converter_source_first;
assign datar_datar_conv8_source_source_last = datar_datar_conv8_converter_source_last;
assign datar_datar_conv8_source_source_payload_data = datar_datar_conv8_converter_source_payload_data;
assign datar_datar_conv8_converter_source_valid = datar_datar_conv8_converter_sink_valid;
assign datar_datar_conv8_converter_sink_ready = datar_datar_conv8_converter_source_ready;
assign datar_datar_conv8_converter_source_first = datar_datar_conv8_converter_sink_first;
assign datar_datar_conv8_converter_source_last = datar_datar_conv8_converter_sink_last;
assign datar_datar_conv8_converter_source_payload_data = datar_datar_conv8_converter_sink_payload_data;
assign datar_datar_conv8_converter_source_payload_valid_token_count = 1'd1;
...
always @(*) begin
	...
	datar_datar_source_source_ready <= 1'd0;
	...
	case (litesdcardcore_sdphydatar_state)
		1'd1: begin
			...
			if (datar_datar_source_source_valid) begin
		...
		2'd2: begin
			datar_pads_out_payload_clk <= 1'd1;
			datar_source_valid <= datar_datar_source_source_valid;
			...
			datar_source_payload_data <= datar_datar_source_source_payload_data;
			if (datar_source_valid) begin
				if (datar_source_ready) begin
					datar_datar_source_source_ready <= 1'd1;
...
assign csrbank5_bus_width0_r = interface5_bank_bus_dat_w[1:0];
always @(*) begin
	csrbank5_bus_width0_we <= 1'd0;
	csrbank5_bus_width0_re <= 1'd0;
	if ((csrbank5_sel & (interface5_bank_bus_adr[8:0] == 3'd4))) begin
		csrbank5_bus_width0_re <= interface5_bank_bus_we;
		csrbank5_bus_width0_we <= (~interface5_bank_bus_we);
	end
end
...
assign csrbank5_bus_width0_w = bus_width_storage[1:0];
...
always @(posedge sdrio_clk) begin
	...
	xilinxsdrtristateimpl5__o <= sdpads_data_o[4];
	xilinxsdrtristateimpl5_oe_n <= (~sdpads_data_oe);
	sdpads_data_i[4] <= xilinxsdrtristateimpl5__i;
	xilinxsdrtristateimpl6__o <= sdpads_data_o[5];
	xilinxsdrtristateimpl6_oe_n <= (~sdpads_data_oe);
	sdpads_data_i[5] <= xilinxsdrtristateimpl6__i;
	xilinxsdrtristateimpl7__o <= sdpads_data_o[6];
	xilinxsdrtristateimpl7_oe_n <= (~sdpads_data_oe);
	sdpads_data_i[6] <= xilinxsdrtristateimpl7__i;
	xilinxsdrtristateimpl8__o <= sdpads_data_o[7];
	xilinxsdrtristateimpl8_oe_n <= (~sdpads_data_oe);
	sdpads_data_i[7] <= xilinxsdrtristateimpl8__i;
end
...
always @(posedge sys_clk) begin
	...
	if (cmdr_cmdr_conv1_converter_source_ready) begin
		cmdr_cmdr_conv1_converter_strobe_all <= 1'd0;
	end
	if (cmdr_cmdr_conv1_converter_load_part) begin
		if (((cmdr_cmdr_conv1_converter_demux == 3'd7) | cmdr_cmdr_conv1_converter_sink_last)) begin
			cmdr_cmdr_conv1_converter_demux <= 1'd0;
			cmdr_cmdr_conv1_converter_strobe_all <= 1'd1;
		end else begin
			cmdr_cmdr_conv1_converter_demux <= (cmdr_cmdr_conv1_converter_demux + 1'd1);
		end
	end
	if ((cmdr_cmdr_conv1_converter_source_valid & cmdr_cmdr_conv1_converter_source_ready)) begin
		if ((cmdr_cmdr_conv1_converter_sink_valid & cmdr_cmdr_conv1_converter_sink_ready)) begin
			cmdr_cmdr_conv1_converter_source_first <= cmdr_cmdr_conv1_converter_sink_first;
			cmdr_cmdr_conv1_converter_source_last <= cmdr_cmdr_conv1_converter_sink_last;
		end else begin
			cmdr_cmdr_conv1_converter_source_first <= 1'd0;
			cmdr_cmdr_conv1_converter_source_last <= 1'd0;
		end
	end else begin
		if ((cmdr_cmdr_conv1_converter_sink_valid & cmdr_cmdr_conv1_converter_sink_ready)) begin
			cmdr_cmdr_conv1_converter_source_first <= (cmdr_cmdr_conv1_converter_sink_first | cmdr_cmdr_conv1_converter_source_first);
			cmdr_cmdr_conv1_converter_source_last <= (cmdr_cmdr_conv1_converter_sink_last | cmdr_cmdr_conv1_converter_source_last);
		end
	end
	if (cmdr_cmdr_conv1_converter_load_part) begin
		case (cmdr_cmdr_conv1_converter_demux)
			1'd0: begin
				cmdr_cmdr_conv1_converter_source_payload_data[7] <= cmdr_cmdr_conv1_converter_sink_payload_data;
			end
			1'd1: begin
				cmdr_cmdr_conv1_converter_source_payload_data[6] <= cmdr_cmdr_conv1_converter_sink_payload_data;
			end
			2'd2: begin
				cmdr_cmdr_conv1_converter_source_payload_data[5] <= cmdr_cmdr_conv1_converter_sink_payload_data;
			end
			2'd3: begin
				cmdr_cmdr_conv1_converter_source_payload_data[4] <= cmdr_cmdr_conv1_converter_sink_payload_data;
			end
			3'd4: begin
				cmdr_cmdr_conv1_converter_source_payload_data[3] <= cmdr_cmdr_conv1_converter_sink_payload_data;
			end
			3'd5: begin
				cmdr_cmdr_conv1_converter_source_payload_data[2] <= cmdr_cmdr_conv1_converter_sink_payload_data;
			end
			3'd6: begin
				cmdr_cmdr_conv1_converter_source_payload_data[1] <= cmdr_cmdr_conv1_converter_sink_payload_data;
			end
			3'd7: begin
				cmdr_cmdr_conv1_converter_source_payload_data[0] <= cmdr_cmdr_conv1_converter_sink_payload_data;
			end
		endcase
	end
	if (cmdr_cmdr_conv1_converter_load_part) begin
		cmdr_cmdr_conv1_converter_source_payload_valid_token_count <= (cmdr_cmdr_conv1_converter_demux + 1'd1);
	end
	if (cmdr_cmdr_conv4_converter_source_ready) begin
		cmdr_cmdr_conv4_converter_strobe_all <= 1'd0;
	end
	if (cmdr_cmdr_conv4_converter_load_part) begin
		if (((cmdr_cmdr_conv4_converter_demux == 1'd1) | cmdr_cmdr_conv4_converter_sink_last)) begin
			cmdr_cmdr_conv4_converter_demux <= 1'd0;
			cmdr_cmdr_conv4_converter_strobe_all <= 1'd1;
		end else begin
			cmdr_cmdr_conv4_converter_demux <= (cmdr_cmdr_conv4_converter_demux + 1'd1);
		end
	end
	if ((cmdr_cmdr_conv4_converter_source_valid & cmdr_cmdr_conv4_converter_source_ready)) begin
		if ((cmdr_cmdr_conv4_converter_sink_valid & cmdr_cmdr_conv4_converter_sink_ready)) begin
			cmdr_cmdr_conv4_converter_source_first <= cmdr_cmdr_conv4_converter_sink_first;
			cmdr_cmdr_conv4_converter_source_last <= cmdr_cmdr_conv4_converter_sink_last;
		end else begin
			cmdr_cmdr_conv4_converter_source_first <= 1'd0;
			cmdr_cmdr_conv4_converter_source_last <= 1'd0;
		end
	end else begin
		if ((cmdr_cmdr_conv4_converter_sink_valid & cmdr_cmdr_conv4_converter_sink_ready)) begin
			cmdr_cmdr_conv4_converter_source_first <= (cmdr_cmdr_conv4_converter_sink_first | cmdr_cmdr_conv4_converter_source_first);
			cmdr_cmdr_conv4_converter_source_last <= (cmdr_cmdr_conv4_converter_sink_last | cmdr_cmdr_conv4_converter_source_last);
		end
	end
	if (cmdr_cmdr_conv4_converter_load_part) begin
		case (cmdr_cmdr_conv4_converter_demux)
			1'd0: begin
				cmdr_cmdr_conv4_converter_source_payload_data[7:4] <= cmdr_cmdr_conv4_converter_sink_payload_data;
			end
			1'd1: begin
				cmdr_cmdr_conv4_converter_source_payload_data[3:0] <= cmdr_cmdr_conv4_converter_sink_payload_data;
			end
		endcase
	end
	if (cmdr_cmdr_conv4_converter_load_part) begin
		cmdr_cmdr_conv4_converter_source_payload_valid_token_count <= (cmdr_cmdr_conv4_converter_demux + 1'd1);
	end
	...
	if (cmdr_cmdr_reset) begin
		cmdr_cmdr_run <= 1'd0;
		cmdr_cmdr_conv1_converter_source_payload_data <= 8'd0;
		cmdr_cmdr_conv1_converter_source_payload_valid_token_count <= 4'd0;
		cmdr_cmdr_conv1_converter_demux <= 3'd0;
		cmdr_cmdr_conv1_converter_strobe_all <= 1'd0;
		cmdr_cmdr_conv4_converter_source_payload_data <= 8'd0;
		cmdr_cmdr_conv4_converter_source_payload_valid_token_count <= 2'd0;
		cmdr_cmdr_conv4_converter_demux <= 1'd0;
		cmdr_cmdr_conv4_converter_strobe_all <= 1'd0;
	...
	if (dataw_crc_conv1_converter_source_ready) begin
		dataw_crc_conv1_converter_strobe_all <= 1'd0;
	end
	if (dataw_crc_conv1_converter_load_part) begin
		if (((dataw_crc_conv1_converter_demux == 3'd7) | dataw_crc_conv1_converter_sink_last)) begin
			dataw_crc_conv1_converter_demux <= 1'd0;
			dataw_crc_conv1_converter_strobe_all <= 1'd1;
		end else begin
			dataw_crc_conv1_converter_demux <= (dataw_crc_conv1_converter_demux + 1'd1);
		end
	end
	if ((dataw_crc_conv1_converter_source_valid & dataw_crc_conv1_converter_source_ready)) begin
		if ((dataw_crc_conv1_converter_sink_valid & dataw_crc_conv1_converter_sink_ready)) begin
			dataw_crc_conv1_converter_source_first <= dataw_crc_conv1_converter_sink_first;
			dataw_crc_conv1_converter_source_last <= dataw_crc_conv1_converter_sink_last;
		end else begin
			dataw_crc_conv1_converter_source_first <= 1'd0;
			dataw_crc_conv1_converter_source_last <= 1'd0;
		end
	end else begin
		if ((dataw_crc_conv1_converter_sink_valid & dataw_crc_conv1_converter_sink_ready)) begin
			dataw_crc_conv1_converter_source_first <= (dataw_crc_conv1_converter_sink_first | dataw_crc_conv1_converter_source_first);
			dataw_crc_conv1_converter_source_last <= (dataw_crc_conv1_converter_sink_last | dataw_crc_conv1_converter_source_last);
		end
	end
	if (dataw_crc_conv1_converter_load_part) begin
		case (dataw_crc_conv1_converter_demux)
			1'd0: begin
				dataw_crc_conv1_converter_source_payload_data[7] <= dataw_crc_conv1_converter_sink_payload_data;
			end
			1'd1: begin
				dataw_crc_conv1_converter_source_payload_data[6] <= dataw_crc_conv1_converter_sink_payload_data;
			end
			2'd2: begin
				dataw_crc_conv1_converter_source_payload_data[5] <= dataw_crc_conv1_converter_sink_payload_data;
			end
			2'd3: begin
				dataw_crc_conv1_converter_source_payload_data[4] <= dataw_crc_conv1_converter_sink_payload_data;
			end
			3'd4: begin
				dataw_crc_conv1_converter_source_payload_data[3] <= dataw_crc_conv1_converter_sink_payload_data;
			end
			3'd5: begin
				dataw_crc_conv1_converter_source_payload_data[2] <= dataw_crc_conv1_converter_sink_payload_data;
			end
			3'd6: begin
				dataw_crc_conv1_converter_source_payload_data[1] <= dataw_crc_conv1_converter_sink_payload_data;
			end
			3'd7: begin
				dataw_crc_conv1_converter_source_payload_data[0] <= dataw_crc_conv1_converter_sink_payload_data;
			end
		endcase
	end
	if (dataw_crc_conv1_converter_load_part) begin
		dataw_crc_conv1_converter_source_payload_valid_token_count <= (dataw_crc_conv1_converter_demux + 1'd1);
	end
	if (dataw_crc_conv4_converter_source_ready) begin
		dataw_crc_conv4_converter_strobe_all <= 1'd0;
	end
	if (dataw_crc_conv4_converter_load_part) begin
		if (((dataw_crc_conv4_converter_demux == 1'd1) | dataw_crc_conv4_converter_sink_last)) begin
			dataw_crc_conv4_converter_demux <= 1'd0;
			dataw_crc_conv4_converter_strobe_all <= 1'd1;
		end else begin
			dataw_crc_conv4_converter_demux <= (dataw_crc_conv4_converter_demux + 1'd1);
		end
	end
	if ((dataw_crc_conv4_converter_source_valid & dataw_crc_conv4_converter_source_ready)) begin
		if ((dataw_crc_conv4_converter_sink_valid & dataw_crc_conv4_converter_sink_ready)) begin
			dataw_crc_conv4_converter_source_first <= dataw_crc_conv4_converter_sink_first;
			dataw_crc_conv4_converter_source_last <= dataw_crc_conv4_converter_sink_last;
		end else begin
			dataw_crc_conv4_converter_source_first <= 1'd0;
			dataw_crc_conv4_converter_source_last <= 1'd0;
		end
	end else begin
		if ((dataw_crc_conv4_converter_sink_valid & dataw_crc_conv4_converter_sink_ready)) begin
			dataw_crc_conv4_converter_source_first <= (dataw_crc_conv4_converter_sink_first | dataw_crc_conv4_converter_source_first);
			dataw_crc_conv4_converter_source_last <= (dataw_crc_conv4_converter_sink_last | dataw_crc_conv4_converter_source_last);
		end
	end
	if (dataw_crc_conv4_converter_load_part) begin
		case (dataw_crc_conv4_converter_demux)
			1'd0: begin
				dataw_crc_conv4_converter_source_payload_data[7:4] <= dataw_crc_conv4_converter_sink_payload_data;
			end
			1'd1: begin
				dataw_crc_conv4_converter_source_payload_data[3:0] <= dataw_crc_conv4_converter_sink_payload_data;
			end
		endcase
	end
	if (dataw_crc_conv4_converter_load_part) begin
		dataw_crc_conv4_converter_source_payload_valid_token_count <= (dataw_crc_conv4_converter_demux + 1'd1);
	end
	...
	if (dataw_crc_reset) begin
		dataw_crc_run <= 1'd0;
		dataw_crc_conv1_converter_source_payload_data <= 8'd0;
		dataw_crc_conv1_converter_source_payload_valid_token_count <= 4'd0;
		dataw_crc_conv1_converter_demux <= 3'd0;
		dataw_crc_conv1_converter_strobe_all <= 1'd0;
		dataw_crc_conv4_converter_source_payload_data <= 8'd0;
		dataw_crc_conv4_converter_source_payload_valid_token_count <= 2'd0;
		dataw_crc_conv4_converter_demux <= 1'd0;
		dataw_crc_conv4_converter_strobe_all <= 1'd0;
	...
	if (datar_datar_conv1_converter_source_ready) begin
		datar_datar_conv1_converter_strobe_all <= 1'd0;
	end
	if (datar_datar_conv1_converter_load_part) begin
		if (((datar_datar_conv1_converter_demux == 3'd7) | datar_datar_conv1_converter_sink_last)) begin
			datar_datar_conv1_converter_demux <= 1'd0;
			datar_datar_conv1_converter_strobe_all <= 1'd1;
		end else begin
			datar_datar_conv1_converter_demux <= (datar_datar_conv1_converter_demux + 1'd1);
		end
	end
	if ((datar_datar_conv1_converter_source_valid & datar_datar_conv1_converter_source_ready)) begin
		if ((datar_datar_conv1_converter_sink_valid & datar_datar_conv1_converter_sink_ready)) begin
			datar_datar_conv1_converter_source_first <= datar_datar_conv1_converter_sink_first;
			datar_datar_conv1_converter_source_last <= datar_datar_conv1_converter_sink_last;
		end else begin
			datar_datar_conv1_converter_source_first <= 1'd0;
			datar_datar_conv1_converter_source_last <= 1'd0;
		end
	end else begin
		if ((datar_datar_conv1_converter_sink_valid & datar_datar_conv1_converter_sink_ready)) begin
			datar_datar_conv1_converter_source_first <= (datar_datar_conv1_converter_sink_first | datar_datar_conv1_converter_source_first);
			datar_datar_conv1_converter_source_last <= (datar_datar_conv1_converter_sink_last | datar_datar_conv1_converter_source_last);
		end
	end
	if (datar_datar_conv1_converter_load_part) begin
		case (datar_datar_conv1_converter_demux)
			1'd0: begin
				datar_datar_conv1_converter_source_payload_data[7] <= datar_datar_conv1_converter_sink_payload_data;
			end
			1'd1: begin
				datar_datar_conv1_converter_source_payload_data[6] <= datar_datar_conv1_converter_sink_payload_data;
			end
			2'd2: begin
				datar_datar_conv1_converter_source_payload_data[5] <= datar_datar_conv1_converter_sink_payload_data;
			end
			2'd3: begin
				datar_datar_conv1_converter_source_payload_data[4] <= datar_datar_conv1_converter_sink_payload_data;
			end
			3'd4: begin
				datar_datar_conv1_converter_source_payload_data[3] <= datar_datar_conv1_converter_sink_payload_data;
			end
			3'd5: begin
				datar_datar_conv1_converter_source_payload_data[2] <= datar_datar_conv1_converter_sink_payload_data;
			end
			3'd6: begin
				datar_datar_conv1_converter_source_payload_data[1] <= datar_datar_conv1_converter_sink_payload_data;
			end
			3'd7: begin
				datar_datar_conv1_converter_source_payload_data[0] <= datar_datar_conv1_converter_sink_payload_data;
			end
		endcase
	end
	if (datar_datar_conv1_converter_load_part) begin
		datar_datar_conv1_converter_source_payload_valid_token_count <= (datar_datar_conv1_converter_demux + 1'd1);
	end
	if (datar_datar_conv4_converter_source_ready) begin
		datar_datar_conv4_converter_strobe_all <= 1'd0;
	end
	if (datar_datar_conv4_converter_load_part) begin
		if (((datar_datar_conv4_converter_demux == 1'd1) | datar_datar_conv4_converter_sink_last)) begin
			datar_datar_conv4_converter_demux <= 1'd0;
			datar_datar_conv4_converter_strobe_all <= 1'd1;
		end else begin
			datar_datar_conv4_converter_demux <= (datar_datar_conv4_converter_demux + 1'd1);
		end
	end
	if ((datar_datar_conv4_converter_source_valid & datar_datar_conv4_converter_source_ready)) begin
		if ((datar_datar_conv4_converter_sink_valid & datar_datar_conv4_converter_sink_ready)) begin
			datar_datar_conv4_converter_source_first <= datar_datar_conv4_converter_sink_first;
			datar_datar_conv4_converter_source_last <= datar_datar_conv4_converter_sink_last;
		end else begin
			datar_datar_conv4_converter_source_first <= 1'd0;
			datar_datar_conv4_converter_source_last <= 1'd0;
		end
	end else begin
		if ((datar_datar_conv4_converter_sink_valid & datar_datar_conv4_converter_sink_ready)) begin
			datar_datar_conv4_converter_source_first <= (datar_datar_conv4_converter_sink_first | datar_datar_conv4_converter_source_first);
			datar_datar_conv4_converter_source_last <= (datar_datar_conv4_converter_sink_last | datar_datar_conv4_converter_source_last);
		end
	end
	if (datar_datar_conv4_converter_load_part) begin
		case (datar_datar_conv4_converter_demux)
			1'd0: begin
				datar_datar_conv4_converter_source_payload_data[7:4] <= datar_datar_conv4_converter_sink_payload_data;
			end
			1'd1: begin
				datar_datar_conv4_converter_source_payload_data[3:0] <= datar_datar_conv4_converter_sink_payload_data;
			end
		endcase
	end
	if (datar_datar_conv4_converter_load_part) begin
		datar_datar_conv4_converter_source_payload_valid_token_count <= (datar_datar_conv4_converter_demux + 1'd1);
	end
	...
	if (datar_datar_reset) begin
		...
		datar_datar_conv1_converter_source_payload_data <= 8'd0;
		datar_datar_conv1_converter_source_payload_valid_token_count <= 4'd0;
		datar_datar_conv1_converter_demux <= 3'd0;
		datar_datar_conv1_converter_strobe_all <= 1'd0;
		datar_datar_conv4_converter_source_payload_data <= 8'd0;
		datar_datar_conv4_converter_source_payload_valid_token_count <= 2'd0;
		datar_datar_conv4_converter_demux <= 1'd0;
		datar_datar_conv4_converter_strobe_all <= 1'd0;
	...
	if (csrbank5_sel) begin
		case (interface5_bank_bus_adr[8:0])
			...
			3'd4: begin
				interface5_bank_bus_dat_r <= csrbank5_bus_width0_w;
			end
		endcase
	end
	...
	if (csrbank5_bus_width0_re) begin
		bus_width_storage[1:0] <= csrbank5_bus_width0_r;
	end
	bus_width_re <= csrbank5_bus_width0_re;
	if (sys_rst) begin
		reset_storage <= 2'd0;
		reset_re <= 1'd0;
		...
		litesdcardcore_sdphydataw_state <= 4'd0;
...
IOBUF IOBUF_5(
	.I(xilinxsdrtristateimpl5__o),
	.T(xilinxsdrtristateimpl5_oe_n),
	.IO(sdcard_data[4]),
	.O(xilinxsdrtristateimpl5__i)
);

IOBUF IOBUF_6(
	.I(xilinxsdrtristateimpl6__o),
	.T(xilinxsdrtristateimpl6_oe_n),
	.IO(sdcard_data[5]),
	.O(xilinxsdrtristateimpl6__i)
);

IOBUF IOBUF_7(
	.I(xilinxsdrtristateimpl7__o),
	.T(xilinxsdrtristateimpl7_oe_n),
	.IO(sdcard_data[6]),
	.O(xilinxsdrtristateimpl7__i)
);

IOBUF IOBUF_8(
	.I(xilinxsdrtristateimpl8__o),
	.T(xilinxsdrtristateimpl8_oe_n),
	.IO(sdcard_data[7]),
	.O(xilinxsdrtristateimpl8__i)
);

endmodule

// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-10-20 15:58:55.
//------------------------------------------------------------------------------
